...
<div class="category-form">
    ...
    <div class="row">
        <div class="col-md-4 col-lg-3">
            ...
            <p class="text-muted">Nhập tiêu đề và các mô tả cho danh mục</p>
        </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <?= $form->field($model, 'page_id')->dropDownList(
                            ...
                            [
                                'prompt' => Yii::t('backend', '-- Select page --'),
                                'onchange' => '$.post( "' . Yii::$app->urlManager->createUrl('ajax/get-categories-by-page-id?page_id=') . '"+$(this).val(), function( data ) {
                    ...
                    <div class="form-group">
                        <?= $form->field($model, 'parent_id')->dropDownList(
                            ArrayHelper::map(Category::find()->where(['!=', 'id', $model->id])->all(), 'id', 'title'),
                            [
                    ...
                    <div class="form-group">
                        <?= $form->field($model, 'code')->textarea(['rows' => 2]) ?>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-4 col-lg-3">
            <h4>Hình ảnh</h4>
            <p class="text-muted">Thêm hình ảnh cho danh mục</p>
        </div>
        <div class="col-md-8 col-lg-9">
            <div class="box box-success">
                <div class="box-header">
    ...
    <div class="row">
        <div class="col-md-4 col-lg-3">
            ...
            <p class="text-muted">Nhập mô tả và nội dung cho danh mục</p>
        </div>
        <div class="col-md-8 col-lg-9">
